    ...
    )
{
    ...
    if (IsScalarA) {
        ...
        const int16x8_t va_s16x8 = SUI::vreinterpretq_s16(SUI::vsubl_i8(VectorA, VectorZeroPointA));
    ...
    if (IsScalarB) {
        ...
        const int16x8_t vb_s16x8 = SUI::vreinterpretq_s16(SUI::vsubl_i8(VectorB, VectorZeroPointB));
